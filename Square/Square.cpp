...
double TSquare::GetValue(int i) {
	switch (i / 4) {
	case 0:
		return l1.GetValue(0);
	case 1:
		return l1.GetValue(1);
	case 2:
		return l1.GetValue(2);
	case 3:
		return l1.GetValue(3);
	case 4:
		return l2.GetValue(0);
	case 5:
		return l2.GetValue(1);
	case 6:
		return l2.GetValue(2);
	case 7:
		return l2.GetValue(3);
	case 8:
		return l3.GetValue(0);
	case 9:
		return l3.GetValue(1);
	case 10:
		return l3.GetValue(2);
	case 11:
		return l3.GetValue(3);
	case 12:
		return l4.GetValue(0);
	case 13:
		return l4.GetValue(1);
	case 14:
		return l4.GetValue(2);
	case 15:
		return l4.GetValue(3);
	default:
		throw - 1;
	}
}

void TSquare::SetValue(double val, int i) {
	switch (i / 4) {
	case 0:
		l1.SetValue(val, 0);
		break;
